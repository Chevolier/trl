import os
os.environ['CUDA_VISIBLE_DEVICES'] = '5'  # 指定使用GPU 5

from transformers import AutoProcessor
from vllm import LLM, SamplingParams
from config import USER_PROMPT_TEMPLATE, NFRAMES, VIDEO_MIN_PIXELS, VIDEO_MAX_PIXELS
from video_util_training_aligned import gen_video_qwen_vl_utils
...
def run_evaluation(gen_file: str, gt_file: str = "./video_gpt_responses_gt.jsonl", 
    ...
    markdown_file = output_dir / f"eval_result_aligned_{gen_file_name}_{cur_time}.md"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_path", 
        type=str, 
        default="/home/ec2-user/lumi_project/LLaMA-Factory/model_qwen_32b/checkpoint-564",
        help="模型路径"
    )
    parser.add_argument(
        "--analyse_dir", 
    ...
    parser.add_argument(
        "--predict_dir", 
        type=str, 
        default="../predict_results_aligned",
